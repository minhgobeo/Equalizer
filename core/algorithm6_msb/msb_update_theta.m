% Auto-split from NCKH_v53.m (original line 12426).
% Folder: core/algorithm6_msb

function theta_new = msb_update_theta(theta, x, e, n, v_base, Kffe)
% One Algorithm-5 update: NLMS-like + lambda_n schedule.
    g = (x.'*x) + v_base.delta;
